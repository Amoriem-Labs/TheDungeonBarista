...
namespace TDB
{
    public class ChipmunkWander : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            ChooseNewPoint();
            _cooldownTimerCurrent = CooldownTimerMax;
            GetComponentInChildren<ChipmunkChargeRange>().playerInRange += PlayerInRange;
            GetComponentInChildren<ChipmunkChargeRange>().playerInRange += PlayerOutOfRange;
